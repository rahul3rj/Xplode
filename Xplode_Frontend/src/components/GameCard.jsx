  ...
  return (
    <>
      <div className="relative overflow-hidden">
        ...
        <div
          className={`h-[36vh] rounded-t-lg overflow-hidden shadow-lg cursor-pointer relative duration-600 transform ${
        ...
        >
          <div className="h-[11svh] flex flex-col justify-center items-start">
            ...
            <h3 className="text-white text-sm font-[gilroy-ebold]">Free</h3>

          </div>
          <div
            className={`h-[8svh] flex flex-col transition-opacity absolute right-4 ${
              isActive ? "duration-700" : "duration-300"
            } ease-in-out ${
              isActive ? "opacity-100" : "opacity-0"
            } justify-between items-end`}
          >
            <div className="flex flex-row justify-center items-center gap-2">
              <h3 className="text-white text-xs font-[gilroy-bold]">
                Dark fantasy
              </h3>
              <h3 className="text-[#696969] text-xs font-[gilroy-bold]">
                Action
              </h3>
              <h3 className="text-[#696969] text-xs font-[gilroy-bold]">
                Adventure
        ...
        <div
          className={`absolute -z-10 top-4/6 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-all duration-500 h-[20svh]  ${
