    ...
    <>
      ...
      <div className="h-[12svh] w-full bg-transparent flex justify-between items-center fixed top-0 left-0 z-50">
        <div className="h-[10svh] w-[45%] flex justify-between items-center">
          ...
          <div className="h-[60%] w-[80%] ml-15 relative">
            <img
            ...
            <input
              ...
              type="text"
              className="h-[100%] w-[80%] lg:w-[100%] py-1 font-[Gilroy-bold] rounded-lg bg-[#1B0033] text-[#fff] px-12 outline-none focus:border-white transition-all"
            />
          </div>
        </div>
        ...
        <div className="h-[6svh] w-[39%] flex ml-5 justify-between mr-8 items-center">
          <div className="h-[100%] w-[24%] rounded-full bg-[#1B0033] flex justify-between items-center cursor-pointer">
            <img src="../HomePage/Wallet.svg" alt="" className="ml-4 h-[3svh]" />
            <h4 className="font-[Gilroy-Bold] text-white">₹1500</h4>
            <img src="../HomePage/Polygon 6.svg" alt="" className="mr-4 h-[1.5svh]" />
          </div>
          <div className="h-[6svh] w-[6svh] rounded-full bg-[#1B0033] flex justify-center items-center cursor-pointer">
            <img src="../HomePage/Heart.svg" alt="" className="h-[3svh] w-[3svh]"/>
          </div>
          <div className="h-[6svh] w-[6svh] rounded-full bg-[#1B0033] flex justify-center items-center cursor-pointer">
            <img src="../HomePage/Doorbell.svg" alt="" className="h-[3svh] w-[3svh]"/>
          </div>
          <div className="h-[6svh] w-[6svh] rounded-full bg-[#1B0033] flex justify-center items-center cursor-pointer">
            <img src="../HomePage/Shopping Cart.svg" alt="" className="h-[3svh] w-[3svh]"/>
          </div>
          <Link to={"/profile"} className="h-[5svh] w-[27%] flex justify-between items-center cursor-pointer">
            ...
            <img src="../HomePage/Polygon 6.svg" alt="" className="h-[1.5svh]"/>
          </Link>
        </div>
      </div>
    </>
