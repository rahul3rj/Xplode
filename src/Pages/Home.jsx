...
function Home() {
    ...
    return (
      <div className="h-[290vh] w-[100vw] bg-[#121921] relative ">
        ...
        <div className="navSide h-[100vh] w-[16vw]  flex flex-col justify-center items-center absolute">
          ...
          <div className="icons h-[60vh] w-[16vw] flex items-center mt-5 ">
            ...
            <div className="h-[60vh] w-[11vw] ">
              <div className="h-[6vh] w-[11vw] flex items-center justify-center ">
                ...
                <div className="h-[6vh] w-[8vw] text-[#D65F30] istok-web-regular flex justify-strat items-center p-3 cursor-pointer ">
                ...
                <div className="h-[6vh] w-[11vw] flex items-center justify-center">
                  <div className="h-[6vh] w-[3vw] flex items-center justify-center relative cursor-pointer">
                    <img
                      ...
                      className="z-10"
                    />
                    {/* <div className='h-[2vh] w-[5vh] bg-[#D65F30] rounded-full absolute blur'></div> */}
                  </div>
                  <div className="h-[6vh] w-[8vw] text-white istok-web-regular flex justify-strat items-center p-3 cursor-pointer ">
        ...
        <div className="h-[90vh] w-[84vw] absolute right-0 top-22.5 ">
          <div className="h-[65vh] w-[81vw]  flex">
            {/* <div className='Cover_img h-[60vh] w-[55vw] bg-zinc-600 rounded-2xl overflow-hidden'>
                        <img src="/cover1.jpg" className='h-full w-full object-cover' alt="" />
                    </div>
                    <div className='h-[65vh] w-[31vw] flex relative'>
                        <div className='h-[40vh] w-[27vw] bg-[#121921] mx-5 rounded-2xl absolute z-0 istok-web-regular'>
                            <h1 className='absolute z-20 text-white istok-web-regular text-[3vh] ml-10 mt-10 mb-5 '>Modern Warfare 3</h1>
                            <p className='w-[20vw] absolute z-20 top-21 text-zinc-400 istok-web-regular text-[2vh] ml-10 pt-5 mb-5'>Modern Warfare 3 (2023) is a fast-paced FPS where Task Force 141 battles Makarov in an intense campaign with evolved multiplayer.</p>
                            <p className='w-[20vw] absolute z-20 top-51 text-white istok-web-regular text-[2vh] ml-10 pt-5 mb-5'>₹2999 INR</p>
                        ...
                        <div className='h-[25vh] w-[27vw] absolute bottom-0 mx-5 flex '>
                            <div className='h-[18vh] w-[13vw] bg-[#121921]  my-5 mr-5 rounded-2xl overflow-hidden'>
                                <img src="/img_1.jpg" className='h-full w-full object-cover' alt="" />
                            </div>
                            <div className='h-[18vh] w-[13vw] bg-[#121921]  my-5 rounded-2xl overflow-hidden'>
                                <img src="/img_2.jpg" className='h-full w-full object-cover' alt="" />
                            </div>
                        </div>
                    </div> */}
            <GameSlider />
